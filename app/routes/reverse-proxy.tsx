...
import {type ActionArgs, type LoaderArgs} from '@shopify/remix-oxygen';
...
export async function actions({request}: ActionArgs) {
 ...
 */
function handleCorsOptions(request: LoaderArgs['request']) {
 ...
 * @see https://developer.mozilla.org/en-US/docs/Web/API/Response
 */
async function handleRequest(request: LoaderArgs['request']) {
  const url = new URL(request.url);
